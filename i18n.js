const translations = {
  ...
  sw: {
    ...
    // Hero
      ...
      "appointment.subtitle": "Tuambie ungetaka kujadili nini na uchague muda ujao unaokufaa.",
      "appointment.nameLabel": "Jina Kamili",
      "appointment.namePlaceholder": "Weka jina lako kamili",
      "appointment.emailLabel": "Anwani ya Barua Pepe",
      "appointment.emailPlaceholder": "Weka barua pepe yako",
      "appointment.datetimeLabel": "Tarehe na saa unayopendelea",
      "appointment.timeHint": "Chagua tarehe na saa ya siku zijazo.",
      "appointment.phoneLabel": "Namba ya simu (hiari)",
      "appointment.phonePlaceholder": "Weka namba yako ya simu",
      "appointment.reasonLabel": "Sababu / lengo la miadi",
      "appointment.reasonPlaceholder": "Ungependa kujadili nini?",
      "appointment.notesLabel": "Maelezo ya ziada (hiari)",
...
const savedLang = localStorage.getItem("mlue-lang");
