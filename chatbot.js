(function (global) {
    ...
    // ===================================================
    // MLUE ASSISTANT â€” SESSION & COMMUNICATION PROTOCOL
    // ===================================================

    const CHATBOT_STORAGE_KEY = "mlue-assistant-state-v1";
    ...
    const ENGLISH_HINT_WORDS = [
        ...
        "why", "is", "are", "the", "you", "your", "i", "need", "want",
        "know", "learn", "more", "details", "about", "info", "information"
    ];
    ...
    function getLanguageScores(text) {
        ...
        words.forEach(word => {
            ...
            if (SWAHILI_HINT_WORDS.includes(word)) {
                swahiliScore += 1;
            }

            if (ENGLISH_HINT_WORDS.includes(word)) {
                englishScore += 1;
            }
        ...
        if (
            /\b(ni|wa|ya|za|la|cha|kwa|katika|hiyo|hili|huyu)\b/
                .test(normalized)
        ) {
            swahiliScore += 1;
        }
        ...
        if (
            /\b(the|and|for|with|from|about|this|that)\b/
                .test(normalized)
        ) {
            englishScore += 1;
        }
    ...
    function inferPreferredLanguage(text) {
        ...
        // For short prompts, one strong cue should
        // be enough to identify the language.
        if (wordsCount <= 4) {
        ...
        return swahiliScore > englishScore
            ? "swahili"
            : "english";
    }
    ...
    // =====================================================
    // MLUE TECHNOLOGY â€” BUSINESS KNOWLEDGE
    // =====================================================
        ...
        solutions: {
            ...
            businessSoftware: {
                ...
                title: {
                    ...
                    swahili:
                        "Suluhisho za Programu za Biashara"
                },
    ...
    globalThis.mlueBusinessRules =
        businessRules;



    // ===================================================
    // MLUE ASSISTANT â€” COMMUNICATION PROTOCOL
    // Greeting + Language + Conversation Stage
    // ===================================================
    ...
    function detectSubstantiveRequest(
        message,
        detectedIntent,
        solutionContext
    ) {
        ...
        const hasSolutionContext =
            Boolean(solutionContext?.solution) ||
            Boolean(solutionContext?.domain) ||
            Boolean(
                solutionContext?.requirements?.length
            );
    ...
    function getAssistantIntroduction(language) {

    if (language === "swahili") {

        return (
            "Habari! \u{1F44B} Mimi ni MLUE Assistant, msaidizi wa kidijitali wa MLUE TECHNOLOGY.\n\n" +

            "Ninaweza kukusaidia kufahamu huduma zetu, miradi, suluhisho za kidijitali, bei, pamoja na fursa za ushirikiano.\n\n" +

            "Leo ungependa tukusaidie kuhusu nini?"
        );

    }

    return (
        "Hello! \u{1F44B} I'm MLUE Assistant, the digital assistant for MLUE TECHNOLOGY.\n\n" +

        "I can help you explore our services, projects, digital solutions, pricing, and collaboration opportunities.\n\n" +
    ...
    const INTENTS = [
...

        {
            ...
            patterns: [
                ...
                {
                    value: "unatoa huduma gani",
                    weight: 4
                },

                {
                    value: "mnajihusisha na nini",
                    weight: 4
                },
                ...
                {
                    value: "what do you offer",
                    weight: 3
                },

                {
                    value: "what do you provide",
                    weight: 3
                },

                {
                    value: "nifafanulie huduma zenu",
                    weight: 4
                },

                {
                    value: "nifafanulie huduma mlue",
                    weight: 4
                },

                {
                    value:
                        "nifafanulie huduma mlue technology",
                    weight: 5
                }
...

        {
            ...
            patterns: [
                ...
                {
                    value:
                        "nifafanulie jinsi ya kuwasiliana nanyi",
                    weight: 5
                },

                {
                    value:
                        "nifafanulie jinsi ya kuwasiliana na mlue",
                    weight: 5
                },

                {
                    value:
                        "nifafanulie jinsi ya kuwasiliana na mlue technology",
                    weight: 5
                },
                ...
                {
                    value:
                        "ninaweza kuwasiliana nanyi",
                    weight: 4
                },

                {
                    value:
                        "ninaweza kuwasiliana na mlue",
                    weight: 4
                },

                {
                    value:
                        "ninaweza kuwasiliana na mlue technology",
                    weight: 5
                }
...

        {
            ...
            patterns: [
                ...
                {
                    value:
                        "nifafanulie bei zenu",
                    weight: 4
                },

                {
                    value:
                        "nifafanulie bei mlue",
                    weight: 4
                },

                {
                    value:
                        "nifafanulie bei mlue technology",
                    weight: 5
                },
                ...
                {
                    value:
                        "ni bei gani huduma zenu",
                    weight: 5
                },

                {
                    value:
                        "ni bei gani huduma mlue",
                    weight: 5
                },

                {
                    value:
                        "ni bei gani huduma mlue technology",
                    weight: 5
                },

                {
                    value:
                        "nahitaji kujua bei za huduma zenu",
                    weight: 5
                },

                {
                    value:
                        "nahitaji kujua bei za huduma mlue",
                    weight: 5
                },

                {
                    value:
                        "nahitaji kujua bei za huduma mlue technology",
                    weight: 5
                },
...

        {
            ...
            patterns: [
                ...
                {
                    value:
                        "nifafanulie msaada wenu",
                    weight: 5
                },

                {
                    value:
                        "nifafanulie msaada mlue",
                    weight: 5
                },

                {
                    value:
                        "nifafanulie msaada mlue technology",
                    weight: 5
                },
                ...
                {
                    value:
                        "ninaweza kupata msaada gani kutoka kwenu",
                    weight: 5
                },

                {
                    value:
                        "ninaweza kupata msaada gani kutoka mlue",
                    weight: 5
                },

                {
                    value:
                        "ninaweza kupata msaada gani kutoka mlue technology",
                    weight: 5
                }
...

        {
            ...
            patterns: [
                ...
                {
                    value:
                        "nifafanulie kuhusu mlue technology",
                    weight: 5
                },
                ...
                {
                    value:
                        "nifafanulie kuhusu wewe",
                    weight: 5
                },

                {
                    value:
                        "nifafanulie kuhusu nyie",
                    weight: 5
                },
        ...
        function scoreIntent(intent) {
            ...
            intent.patterns.forEach(
                pattern => {
                    ...
                    // Partial stem support
                    // e.g. helping / services
                    if (
                        value.length >= 4 &&
                        words.some(
                            word =>
            ...
            // Additional ABOUT detection
            if (
                intent.name === "about"
            ) {

                if (
                    normalized.includes("mlue") &&
                    (
                        normalized.includes("who") ||
                        normalized.includes("about") ||
                        normalized.includes("kuhusu") ||
                        normalized.includes("nani") ||
                        normalized.includes("nini")
                    )
                ) {
                    score += 3;
                }
            ...
            // Additional language-switch detection
            if (
                intent.name === "switchingLanguage"
            ) {

                if (
                    normalized.includes("swahili") ||
                    normalized.includes("kiswahili") ||
                    normalized.includes("english") ||
                    normalized.includes("kiingereza")
                ) {
                    score += 2;
                }
        ...
        for (
            ...
            if (
                ...
                const currentPriority =
                    INTENT_RESPONSE_PRIORITY.indexOf(
                        bestIntent
                    );
    ...
    // ===================================================
    // MLUE Chatbot â€” Solution Context Detection
    ...
    // ===================================================
    // MLUE Chatbot â€” Business Rule Resolver
    ...
    function resolveBusinessRule(message, detectedIntent, solutionContext) {
        ...
        // -------------------------------------------------
        // 00 â€” SOLUTION CONTEXT PRIORITY
        // -------------------------------------------------
        ...
        // -------------------------------------------------
        // 01 â€” EXACT / SPECIFIC LOCATION REQUEST
        // -------------------------------------------------
    ...
    // ===================================================
    // MLUE CHATBOT â€” SOLUTION CONTEXT ENGINE
    ...
    function detectSolutionContext(message) {
        ...
        requirementPatterns.forEach(
            requirement => {

                const matched =
                    requirement.patterns.some(
                        pattern =>
                            text.includes(pattern)
                    );
    ...
    function mergeSolutionContext(
        ...
        // use the current context normally.
        if (
            !isContinuation ||
            !previousContext
        ) {
        ...
        // If the current message does not identify
        // a domain, inherit the previous domain.
        const mergedDomain =
            currentContext.domain ||
            previousContext.domain;


        const mergedSolution =
            currentContext.solution ||
            previousContext.solution;


        // Combine old + new requirements
        // without duplicates.
    ...
    // ===================================================
    // MLUE CHATBOT â€” SOLUTION CONTEXT MEMORY
    ...
    // ===================================================
    // MLUE CHATBOT â€” CONSULTATION QUESTION ENGINE
    ...
    function getNextConsultationQuestion(
        ...
        if (
            ...
            if (
                !requirements.includes("patients")
            ) {
            ...
            if (
                !requirements.includes("reporting")
            ) {
        ...
        if (
            ...
            if (
                !requirements.includes("students")
            ) {
        ...
        if (
            ...
            if (
                !requirements.includes("inventory")
            ) {
            ...
            if (
                !requirements.includes("customers")
            ) {
    ...
    // ===================================================
    // MLUE CHATBOT â€” RESPONSE ENGINE
    // ===================================================
    ...
    function generateResponse(
        ...
        const knowledgeBase = {
            ...
            greeting: {
                ...
                swahili:
                    "Habari! Karibu MLUE Technology, tunaweza kukusaidia kwenye masuala ya kiteknolojia. Mimi ni msaidizi wako wa haraka, nikusaidie na nini leo? Unaweza kuchagua lugha ya mawasiliano, tukiwa na uwezo wa kuzungumza kwa Kiswahili na Kiingereza.",

                english:
                    "Hello! Welcome to MLUE Technology, we can assist you with technology-related matters. I am your quick assistant, how can I help you today? You can choose your preferred language for communication, as we are capable of conversing in both Swahili and English."
            ...
            services: {
                ...
                swahili:
                    "MLUE Technology hutoa suluhisho za kiteknolojia zinazolenga kuboresha namna biashara zinavyofanya kazi, kufanya maamuzi, na kukua. Huduma zetu zinajumuisha Custom Software, Business Systems, API / Backend, E-Commerce, GIS / Location Intelligence, na AI / Intelligent Systems. Ungependa kujua zaidi kuhusu suluhisho gani?",

                english:
                    "MLUE Technology provides technology solutions designed to improve how businesses operate, make decisions, and grow. Our solutions include Custom Software, Business Systems, API / Backend, E-Commerce, GIS / Location Intelligence, and AI / Intelligent Systems. Which solution would you like to explore?"
            ...
            contact: {
                ...
                swahili:
                    "Unaweza kuwasiliana na timu ya msaada ya Mlue kupitia barua pepe: mluetechnologytz@gmail.com, au kupitia simu: +255 752 804 154 na kupitia tovuti yetu https://mluetechnology.me.",

                english:
                    "You can contact the Mlue support team via email: mluetechnologytz@gmail.com, or by phone: +255 752 804 154, or through our website https://mluetechnology.me."
            ...
            price: {
                ...
                swahili:
                    "Bei za huduma zetu zinategemea aina ya huduma unayohitaji. Tafadhali tembelea tovuti yetu https://mluetechnology.me/pricing au wasiliana nasi kwa maelezo zaidi ili tuweze kutoa nukuu sahihi kwa mahitaji yako.",

                english:
                    "The prices of our services depend on the type of service you need. Please visit our website https://mluetechnology.me/pricing or contact us for more details so we can provide an accurate quote for your needs."
            ...
            support: {
                ...
                swahili:
                    "Timu yetu ya msaada iko tayari kukusaidia na masuala yoyote unayoweza kuwa nayo. Tafadhali wasiliana nasi kupitia barua pepe: mluetechnologytz@gmail.com",

                english:
                    "Our support team is ready to assist you with any questions or issues you may have. Please contact us via email: mluetechnologytz@gmail.com"
            ...
            unknown: {
                ...
                swahili:
                    "Samahani, nipo hapa kukusaidia kuhusu Mlue Technology Pekee. Tafadhali wasiliana na timu ya msaada ya Mlue kwa maelezo zaidi: kwa barua pepe: mluetechnologytz@gmail.com au kwa simu: +255 752 804 154.",

                english:
                    "Sorry, I am here to assist you with Mlue Technology specifically. Please contact the Mlue support team for more information: via email: mluetechnologytz@gmail.com or by phone: +255 752 804 154."
            ...
            goodbye: {
                ...
                swahili:
                    "Asante kwa kuwasiliana na Mlue Technology. Ikiwa una maswali zaidi, usisite kuuliza! Tunatarajia kukusaidia tena siku zijazo.",

                english:
                    "Thank you for contacting Mlue Technology. If you have any more questions, feel free to ask! We look forward to assisting you again in the future."
            ...
            gracefulClosing: {
                ...
                swahili:
                    "Nafurahi kukusaidia. Ikiwa una maswali zaidi, usisite kuuliza! Tunatarajia kukusaidia tena siku zijazo. Unaweza ukaona kazi zetu kwenye tovuti yetu https://mluetechnology.me/projects",

                english:
                    "I'm glad I could help! If you have any more questions, feel free to ask! We look forward to assisting you again in the future. You can check out our work on our website https://mluetechnology.me/projects"
            ...
            switchingLanguage: {
                ...
                swahili:
                    "Lugha imebadilishwa kwa Kiswahili. Sasa tunaweza kuendelea mazungumzo yetu kwa Kiswahili. Je, kuna jambo lolote unalotaka kujua au kusaidiwa nalo?",

                english:
                    "Language switched to English. We can now continue our conversation in English. Is there anything specific you would like to know or need assistance with?"
        ...
        globalThis.mlueCurrentKnowledgeBase =
            knowledgeBase;


        globalThis.mlueCurrentBusinessRules =
            businessRules;
        ...
        // a complete/new solution context,
        // update the stored context.

        if (
            detectedSolutionContext &&
            detectedSolutionContext.solution ===
                "businessSoftware" &&
        ...
        // If the current message adds
        // requirements but does not specify
        // the domain again, merge them with
        // the previous solution context.
    ...
    // ---------------------------------------------------
    // If there are identified requirements but no
    // specific business domain, provide a useful
    // requirement-focused response.
    // ---------------------------------------------------
    ...
    if (
        ...
        return language === "swahili"
            ...
            ? `Tumeainisha baadhi ya mahitaji ya mfumo wako kama ${requirementText}. Tunaweza kukusaidia kubuni na kujenga mfumo unaoendana na mahitaji ya biashara yako. ${getNextConsultationQuestion(solutionContext, language)}`

            : `We have identified requirements such as ${requirementText}. We can help you design and develop a system around your business needs. ${getNextConsultationQuestion(solutionContext, language)}`;
    }
...
function getDefaultChatbotState() {
    ...
    return {
        ...
        // ===================================================
        // PHASE 1 â€” COMMUNICATION PROTOCOL STATE
        // ===================================================
        ...
        // Whether MLUE Assistant has already
        // introduced itself in this conversation.
        greeted: false,
...
currentSolutionContext = {
    ...
    saveChatState();
        ...
        async function askMLUEAI(userText) {
        ...
        async function sendMessage() {
            ...
            try {
                // Preserve the small typing delay from your existing UI.
                ...
                const requestedLanguage =
                    getLanguageSwitch(userText);

                const inferredLanguage =
                    inferPreferredLanguage(userText);
                ...
                if (requestedLanguage) {
                    ...
                    if (inferredLanguage) {
                        chatLanguage = inferredLanguage;
                    }

                    // ===================================================
                    // 02 — DETECT INTENT / SOLUTION CONTEXT
                    // ===================================================
                    ...
                    const solutionContext =
                        detectSolutionContext(userText);
                    ...
                    const isGreeting =
                        containsGreeting(normalized);

                    // ===================================================
                    // 04 — DETECT WHETHER USER ALSO ASKED SOMETHING
                    // ===================================================

                    const hasRequest =
                        detectSubstantiveRequest(
                            userText,
                            detectedIntent,
                            solutionContext
                        );
                    ...
                    if (isGreeting && !hasRequest) {

                        state.conversationStage =
                            CONVERSATION_STAGES.INTRODUCED;
                    ...
                    // ===================================================
                    ...
                    else if (isGreeting && hasRequest) {

                        state.conversationStage =
                            CONVERSATION_STAGES.ACTIVE;
                        ...
                        try {
                            ...
                            console.error(
                                "MLUE AI request failed:",
                                error
                            );

                            appendMessage(
                                chatLanguage === "swahili"
                                    ? "Samahani, msaidizi wetu wa AI hawezi kujibu kwa sasa. Tafadhali jaribu tena baada ya muda mfupi."
                                    : "Sorry, our AI assistant is temporarily unavailable. Please try again shortly.",
                                "bot"
                            );
                            if (typingNode && typingNode.isConnected) {
                                typingNode.remove();
